...
const PLANES_BASE = [
  {
    ...
    features: [
      { ok: true,  icon: '📋', texto: 'Hasta 50 presupuestos por mes' },
      { ok: true,  icon: '🏗',  texto: 'Hasta 30 obras activas' },
  ...
  },
  {
    ...
    features: [
      { ok: true,  icon: '📋', texto: 'Hasta 200 presupuestos por mes' },
      { ok: true,  icon: '🏗',  texto: 'Hasta 100 obras activas' },
      { ok: true,  icon: '👥', texto: 'Clientes ilimitados' },
      { ok: true,  icon: '🔗', texto: 'Link público para cliente' },
      { ok: true,  icon: '📅', texto: 'Agenda de visitas' },
