        ...
        {items.length > 0 && (
          <div className="rounded-2xl p-4" style={{ background: '#161622', border: '1px solid #1E1E2E' }}>
            ...
            <div className="mt-3 pt-3 flex flex-col gap-1.5" style={{ borderTop: '1px solid #1E1E2E' }}>
              {/* subtotales solo cuando hay 2+ ítems del mismo tipo */}
              {items.filter(i => i.tipo === 'material').length > 1 && totalMat > 0 && (
                <div className="flex justify-between">
                  <span className="text-gray-500 text-[12px]">Subtotal materiales</span>
              ...
              {items.filter(i => i.tipo === 'mano_obra').length > 1 && totalMO > 0 && (
                <div className="flex justify-between">
                  <span className="text-gray-500 text-[12px]">Subtotal mano de obra</span>
